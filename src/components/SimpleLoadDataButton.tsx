...
interface SimpleLoadDataButtonProps {
  onLoadData: (data: any) => void;
}

export function SimpleLoadDataButton({ onLoadData }: SimpleLoadDataButtonProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto mb-6 p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
      <div className="text-center">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">📊 Load Supply Chain Data</h3>
...
export default SimpleLoadDataButton;
