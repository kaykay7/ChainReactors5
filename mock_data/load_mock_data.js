/**
 * Load mock supply chain data into the Supply Chain Optimization Agent
 * 
 * This script provides multiple ways to load the mock data into your application.
 */

// Method 1: Direct import (if using ES modules)
// import mockData from './supply_chain_canvas_data.json';

// Method 2: Fetch from file (if running locally)
export async function loadMockData() {
  try {
    const response = await fetch('/mock_data/supply_chain_canvas_data.json');
...
// Method 3: Direct data object (copy-paste approach)
...
// Usage examples:
console.log('Mock data loaded with', mockSupplyChainData.items.length, 'items');

// To use in your React component:
// const [state, setState] = useState(mockSupplyChainData);
