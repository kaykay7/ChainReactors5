#!/usr/bin/env python3
"""
Generate canvas data from mock supply chain data.

This script creates a JSON file with properly formatted canvas data
that can be directly imported into the Supply Chain Optimization Agent.
"""
...
def generate_canvas_data():
    """Generate canvas data with mock supply chain information."""
...
def main():
    """Generate and save canvas data."""
    print("🚀 Generating mock supply chain data...")
    
    canvas_data = generate_canvas_data()
    ...
    print(f"✅ Generated canvas data with {len(canvas_data['items'])} items")
    ...
    print(f"\n🎯 Next Steps:")
    print(f"1. Copy the JSON data from: {output_file}")
    print(f"2. Use it to populate your canvas in the Supply Chain Optimization Agent")
    print(f"3. Or import it via the Google Sheets integration")
